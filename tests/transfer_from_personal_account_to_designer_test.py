...
from locators import personal_account, registration, name, email, registration_button, password, email_log_in, \
    password_to_your_account, go_button, designer_button
...
# Ожидание
wait = WebDriverWait(driver, 10)  # Увеличьте время ожидания, если необходимо
...
wait.until(EC.element_to_be_clickable((By.XPATH, personal_account))).click()
wait.until(EC.element_to_be_clickable((By.XPATH, designer_button))).click()
time.sleep(5)

...
from locators import personal_account, registration, name, email, registration_button, password, email_log_in, password_to_your_account, go_button, logo
...
wait.until(EC.visibility_of_element_located((By.XPATH, password))).send_keys(passwords)
wait.until(EC.visibility_of_element_located((By.XPATH, email))).send_keys(emails)
...
wait.until(EC.element_to_be_clickable((By.XPATH, personal_account))).click()
time.sleep(2)
wait.until(EC.element_to_be_clickable((By.XPATH, logo))).click()
time.sleep(2)
